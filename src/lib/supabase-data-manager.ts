import { getCurrentScore, setCurrentScore, addScoreHistoryItem, type ScoreHistoryItem } from './supabase-storage';
import { getRewardsByScore, getRandomScore, type ScoreItem, type Reward, getAddItems, getSubtractItems } from './supabase-config';
